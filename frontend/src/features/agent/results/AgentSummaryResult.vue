...
<template>
  <section class="agent-modern-result-card" :aria-label="language === 'zh' ? '工具结果摘要' : 'Tool result summary'">
    ...
    <p v-if="view.message" class="agent-modern-result-message">{{ view.message }}</p>
    <small v-if="view.dataAsOf || view.estimated">
