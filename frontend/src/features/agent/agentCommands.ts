...
export const AGENT_COMMANDS: readonly AgentCommand[] = [
  ...
  { key: "keyword", zh: "关键词商家搜索", en: "Keyword search", zhHint: "产品关键词，例如 vacuum cleaner", enHint: "Product keyword, e.g. vacuum cleaner", template: query("查询关键词", "Search product keyword") },
  ...
  { key: "merchants", zh: "Tier 商户列表", en: "Tier merchants", zhHint: "Tier、条数或分页，例如 Tier 2 前 50 个", enHint: "Tier and limit, e.g. first 50 in Tier 2", showInMenu: false, template: query("列出商户及核心指标", "List merchants and key metrics for") },
  ...
  { key: "unpaid", zh: "未付款记录", en: "Unpaid records", zhHint: "商户或月份，例如 Tapo", enHint: "Merchant or month, e.g. Tapo", showInMenu: false, template: query("查询未支付记录", "Show unpaid records for") },
  { key: "revenue", zh: "收入趋势", en: "Revenue trend", zhHint: "商户、品类或 Tier 与月份", enHint: "Merchant, category, or tier and months", showInMenu: false, template: query("查看收入月度趋势", "Show monthly revenue trends for") },
  { key: "epc", zh: "EPC 趋势", en: "EPC trend", zhHint: "商户、品类或 Tier 与月份", enHint: "Merchant, category, or tier and months", showInMenu: false, template: query("查看 EPC 月度趋势", "Show monthly EPC trends for") },
  { key: "orders", zh: "订单趋势", en: "Order trend", zhHint: "商户、品类或 Tier 与月份", enHint: "Merchant, category, or tier and months", showInMenu: false, template: query("查看订单月度趋势", "Show monthly order trends for") },
  { key: "promotion", zh: "推广追踪", en: "Promotion tracking", zhHint: "需先上传推广清单", enHint: "Upload a promotion list first", template: query("分析推广追踪", "Analyze promotion tracking") }
];

export const AGENT_MENU_COMMANDS: readonly AgentCommand[] = AGENT_COMMANDS.filter((command) => command.showInMenu !== false);
