...
PLANNING_PROMPT_ZH = (
    ...
    "2. 用户查询 ASIN 或产品编号时必须调用 asin_analysis，传入一个或多个 10 位 ASIN；不要把 ASIN 当作商户名。\n"
...
PLANNING_PROMPT_EN = (
    ...
    "2. When the user asks about an ASIN or product identifier, you must call asin_analysis with one or more 10-character ASINs; never treat an ASIN as a merchant name.\n"
